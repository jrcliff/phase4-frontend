  ...
  render() {
    return (
      <div className="timeline">
        ...
        {this.props.posts.map((post, index) => <PostCard updateTimeline={this.props.updateTimeline} user={post.user} post={post} key={index} currentUser={this.props.currentUser}/>)}
      </div>
    );
  }
}
